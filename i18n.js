...
const I18N = {
  zh: {
    ...
    loc_hint: '💡 点击 ✓ 为员工标记工作地点（可多选）。修改后请点击「保存标记」，才能同步至后台。',
    loc_table_title: '员工工作地点标记',
    loc_unsaved_hint: '● 有未保存更改',
    loc_refresh_btn: '🔄 刷新',
    loc_save_btn: '💾 保存标记',
  ...
  en: {
    ...
    loc_hint: '💡 Click ✓ to assign work locations to staff (multiple allowed). Click "Save" to sync changes to the backend.',
    loc_table_title: 'Staff Work Location Assignment',
    loc_unsaved_hint: '● Unsaved changes',
    loc_refresh_btn: '🔄 Refresh',
    loc_save_btn: '💾 Save',
